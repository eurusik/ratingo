 ...
 */
export function useRunDiff(options: { runId: string; sampleSize?: number; enabled?: boolean }) {
...
export function useCreatePolicy() {
  ...
  return useMutation({
    mutationFn: (body: Parameters<typeof adminApi.createPolicy>[0]) => adminApi.createPolicy(body),
    onSuccess: () => {
