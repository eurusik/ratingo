...
describe('ErrorState', () => {
  test('renders inline variant with string error', () => {
    render(<ErrorState error="Network connection failed" variant="inline" />);
  ...
  test('renders section variant with retry button', () => {
    ...
    render(<ErrorState error="Failed to load data" variant="section" retry={mockRetry} />);
  ...
  test('renders page variant', () => {
    render(<ErrorState error="Page not found" variant="page" />);
  ...
  test('renders fallback component when provided', () => {
    ...
    render(<ErrorState error="Some error" fallback={fallback} />);
  ...
  test('defaults to section variant when no variant specified', () => {
    render(<ErrorState error="Default error" />);
  ...
  test('inline variant shows retry button when retry function provided', () => {
    ...
    render(<ErrorState error="Connection error" variant="inline" retry={mockRetry} />);
