    ...
    <main className="min-h-screen bg-cinema-page">
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="flex gap-6 md:gap-10 items-end">
              ...
              <div className="flex-shrink-0 w-32 md:w-48 lg:w-56">
                <div className="aspect-[2/3] relative rounded-xl overflow-hidden bg-cinema-elevated shadow-2xl ring-1 ring-white/20">
                  {poster ? (
                    <>
              ...
              <div className="flex-1 min-w-0 space-y-4 md:space-y-5">
                ...
                <div>
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight drop-shadow-lg">
                    {title || (
                      <span className="inline-block h-10 bg-cinema-elevated rounded animate-pulse w-64" />
                    )}
                  </h1>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="h-8 w-16 bg-cinema-elevated rounded animate-pulse" />
                  <div className="h-8 w-20 bg-cinema-elevated rounded animate-pulse" />
                  <div className="h-8 w-16 bg-cinema-elevated rounded animate-pulse" />
                </div>
              </div>
            </div>
      ...
      <div className="bg-cinema-page">
        <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
          ...
          <div className="mb-8">
            <div className="h-4 bg-cinema-elevated rounded animate-pulse w-3/4 mb-2" />
            <div className="h-4 bg-cinema-elevated rounded animate-pulse w-1/2" />
          </div>

          {/* Verdict skeleton */}
          <div className="bg-cinema-card/50 rounded-xl p-6 mb-8">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-cinema-elevated rounded-full animate-pulse" />
              <div className="flex-1">
                <div className="h-5 bg-cinema-elevated rounded animate-pulse w-48 mb-2" />
                <div className="h-4 bg-cinema-elevated rounded animate-pulse w-32" />
              </div>
            </div>
          </div>
          ...
          {/* Overview skeleton */}
          <div className="mb-8">
            <div className="h-6 bg-cinema-elevated rounded animate-pulse w-32 mb-4" />
            <div className="space-y-2">
              <div className="h-4 bg-cinema-elevated rounded animate-pulse w-full" />
              <div className="h-4 bg-cinema-elevated rounded animate-pulse w-full" />
              <div className="h-4 bg-cinema-elevated rounded animate-pulse w-3/4" />
            </div>
          </div>

          {/* Separator */}
          <div className="h-px bg-cinema-elevated/50 my-12" />

          {/* Trailers skeleton */}
          <div className="mb-8">
            <div className="h-6 bg-cinema-elevated rounded animate-pulse w-24 mb-4" />
            <div className="aspect-video bg-cinema-elevated rounded-xl animate-pulse" />
          </div>
          ...
          {/* Cast skeleton */}
          <div className="mb-8">
            <div className="h-6 bg-cinema-elevated rounded animate-pulse w-20 mb-4" />
            <div className="flex gap-4 overflow-hidden">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex-shrink-0 w-32">
                  <div className="w-32 h-32 bg-cinema-elevated rounded-full animate-pulse mb-2" />
                  <div className="h-4 bg-cinema-elevated rounded animate-pulse w-24 mx-auto" />
                </div>
              ))}
            </div>
          </div>
