...
- [ ] A1. Database Schema Updates
  - [ ] A1.1 Create migration: Extend catalog_evaluation_runs table
...
- [ ] A2. PolicyActivationService Core
  - [ ] A2.1 Create PolicyActivationService class
  ...
  - [ ] A2.2 Implement preparePolicy method
  ...
  - [ ] A2.3 Implement getRunStatus method
    - Fetch run by ID
  ...
  - [ ] A2.4 Implement promoteRun method
...
- [ ] A3. RE_EVALUATE_ALL Job Handler
  - [ ] A3.1 Create RE_EVALUATE_ALL job handler
    - Create `apps/api/src/modules/catalog-policy/application/workers/re-evaluate-all.worker.ts`
    - Accept payload: { runId, policyVersion, batchSize, cursor? }
    - Generate jobId: `reeval:${policyVersion}:${runId}`
    - _Requirements: 4.1, 5.1_

  - [ ] A3.2 Implement batch fetching logic
...
- [ ] A4. EVALUATE_CATALOG_ITEM Job Updates
  - [ ] A4.1 Update EVALUATE_CATALOG_ITEM job handler
