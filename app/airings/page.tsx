...
export const metadata: Metadata = {
  ...
  description:
    "Розклад виходу нових епізодів трендових серіалів. Не пропустіть прем'єри ваших улюблених шоу на найближчі 7-30 днів.",
  openGraph: {
...
export default async function AiringsPage({ searchParams }: { searchParams?: any }) {
  ...
  const initialDays = Math.max(
    1,
    Math.min(30, parseInt(typeof sp?.days === 'string' ? sp.days : '7', 10))
  );
