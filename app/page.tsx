...
import { ClientTrending } from './trending/ClientTrending';
...
export const metadata: Metadata = {
  ...
  description:
    "Відкривайте найпопулярніші серіали за рейтингами TMDB та Trakt. Злети і падіння тижня, топ-3 серіали та найближчі прем'єри.",
  openGraph: {
    title: 'Ratingo — Трендові серіали України',
